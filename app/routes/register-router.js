...
// POST register form
router.post("/", create_update_user_middleware_1.default(user_1.UserDb), login_middleware_1.default(user_1.UserDb, list_users_middleware_1.formatUser), redirect_middleware_1.default("/"));
