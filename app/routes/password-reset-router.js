...
router.post("/:token", reset_password_middleware_1.default(user_1.UserDb), login_middleware_1.default(user_1.UserDb, format_user_1.formatUser), redirect_middleware_1.default("/"));
