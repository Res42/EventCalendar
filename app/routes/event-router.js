...
router.get("/", list_users_middleware_1.default(user_1.UserDb), render_middleware_1.default("create"));
...
router.get("/:eventId", list_users_middleware_1.default(user_1.UserDb), get_modified_event_middleware_1.default(event_1.EventDb), render_middleware_1.default("create"));
